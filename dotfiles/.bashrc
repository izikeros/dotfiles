...
# MATLAB
alias mnw='matlabR2013a -nodisplay -nojvm'
alias mnwj='matlabR2013a -nodisplay'
alias m='matlabR2013a &'
...
alias greph='find ./ -name *.h | xargs grep -n --color'
alias grepm='find ./ -name *.m | xargs grep -n --color'
alias g='grep'
...
# Proxy
set_proxy() {
	#proxy='http://87.254.212.120:8080'
	proxy='10.159.32.152:8080'
